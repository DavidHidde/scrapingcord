...
class ScrapingImplementation:
    ...
    start_urls: list[str]
    parsing_func: Callable[[Response], Union[Iterable[Request], Item]]
    ...
    def __init__(
        ...
        :param parsing_func: Function used for parsing Scrapy responses. Should follow https://docs.scrapy.org/en/latest/topics/spiders.html#scrapy.Spider.parse
